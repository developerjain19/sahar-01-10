...
background: linear-gradient(to bottom, #ffffff 0%,#e1e8ed 100%); height: 100%; margin: 0; background-repeat: no-repeat; background-attachment: fixed;
  ...
  ">
    ...
    background: linear-gradient(to bottom, #ffffff 0%, #e1e8ed 100%);">
            ...
            <img src="https://sahardirectory.com/assets/logo.png" style="float: right; width:200px">  
       ...
       font-size: 3.5rem;
        ...
        letter-spacing: 1px;">नमस्ते ' . $company . '! <br>
  हम आपका हमारी Sahar Directory परिवार में दिल से स्वागत करते है ! <br> Sahar Directory एक free plateform है जो आपको अपनी डिजिटल पहचान बनाने में मदद करता है। और आप जानते हैं कि आज की दुनिया में हमारे लिए डिजिटल रूप से मजबूत होना कितना महत्वपूर्ण है। और हम आपको पूरी तरह से मुफ्त में डिजिटल रूप से मजबूत बनने में मदद करते हैं। यहां आप अपनी वेबसाइट और डिजिटल विजिटिंग कार्ड बिल्कुल मुफ्त प्राप्त कर सकते हैं। तो तैयार हो जाइए खुद को एक डिजिटल पहचान देने और अपने लक्ष्यों तक पहुंचने के लिए। आप अपने बिज़नेस को फ्री में लिस्ट कीजिये ऑनलाइन हमारे प्लेटफॉर्म पर और बनाइये अपनी एक डिजिटल पहचान ताकि ज्यादा से ज्यादा लोगो तक आपकी पहुंच हो सके और आपका बिज़नेस तरक्की करे ! और हमारे साथ आप अपने ग्राहकों को आकर्षित करने के लिए Social Media Graphics भी प्राप्त कर सकते है ! जिसमे आप अपने व्यापार को बढ़ाने के लिए, अपने ग्राहकों को त्योहारों के शुभ सन्देश देने के लिए और भी कई प्रकार के सोशल मीडिया पोस्ट प्राप्त कर सकते है ! </p> <br>
  ...
  <p>निचे आपके अकाउंट की जानकारी शेयर की जा रही है :</p>
  ...
  <br>Facebook : <a href="https://www.facebook.com/sahardirectory" target="_blank"> https://www.facebook.com/sahardirectory</a>
  <br>Instagram : <a href="https://www.instagram.com/sahardirectory" target="_blank"> https://www.instagram.com/sahardirectory</a>
  <br>Linkedin : <a href="https://www.linkedin.com/SaharDirectory" target="_blank"> https://www.linkedin.com/SaharDirectory</a>
  <br>Email : <a href="mailto:hello@sahardirectory.com" target="_blank"> hello@sahardirectory.com</a>
  <br>Support No.: <a href="tel:7419272427"> +91 7419272427 </a>
  <br>Thanks
