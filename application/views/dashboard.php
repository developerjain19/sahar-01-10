...
<div id="main-wrapper">
	...
	<div class="row gray px-4 py-5 mobile_author">
			...
			<div class="dashboard-tlbar d-block mb-5">
				<div class="row">
					...
					<div class="dashboard-widg-bar d-block">
                      <?php if(empty($login_user[0]['company_name'] && $login_user[0]['company_web_title'])){?>
             			 <div class="col-xl-12 col-lg-12 col-md-12 mb-3">
							<div class="dashboard-profile-message bg-inverse text-light d-flex align-items-center" role="alert">
                               <?php if(empty($login_user[0]['company_name'])) { ?>
                              <p class="p-0 m-0 ft-medium full-width">Please Complete your <a href="<?= base_url('my-profile') ?>" class="text-success text-underline">profile</a></p>
                              <?php
                              }else if(empty($login_user[0]['company_web_title'])){
  									?>	
								<p class="p-0 m-0 ft-medium full-width">Please select your <a href="<?= base_url('choose-vcard') ?>" class="text-success text-underline">Vcard Theme</a> to complete your profile!</p>
                              <?php } ?>
							</div>
						</div>
                      <?php } ?>
                      
                      <?php if($login_user[0]['company_name'] && $login_user[0]['company_web_title'] != ''){?>
					...
					<div class="row">
                          <div class="col-xl-4 col-lg-3 col-md-6 col-sm-6">
                              <div class="dsd-boxed-widget py-5 px-4 bg-danger rounded">
                                  ...
                                  <p class="p-0 m-0 text-light fs-md">Products</p>
