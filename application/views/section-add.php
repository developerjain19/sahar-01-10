                        ...
                        <form method="post" class="row" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label class="mb-1">Image (Only: JPG PNG and JPEG)</label>

                                        <?php if ($tag == 'Edit') { ?>
                                            <input type="file" class="form-control rounded" name="section_image_temp" accept=".png,.jpg,.jpeg" />
                                        ...
                                        ?>
                                            <input type="file" class="form-control rounded" name="section_image" accept=".png,.jpg,.jpeg" />
                                        <?php } ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <br>
                                    <div class="form-group">
                                        <button type="submit" class="btn theme-bg text-light rounded"><?= (($tag == 'Edit') ? 'Save Changes' : 'Add Section') ?> </button>
                                    </div>
                                </div>
                            </div>
                        </form>
