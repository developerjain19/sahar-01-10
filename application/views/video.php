                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $roww['title']; ?></td>
                                                            <td><iframe width="120" height="120" src="<?= str_replace("https://www.youtube.com/watch?v=", "https://www.youtube.com/embed/", $roww['video_path']); ?>"></iframe>
                                                            </td>
                                                            <td> <a href="<?= base_url('video') ?>?BdID=<?= $roww['video_id'] ?>" class="button action_btn" onclick="return confirm('Are You Sure?')"><i class="fa fa-trash text-danger"></i></a></td>
                                                        </tr>
