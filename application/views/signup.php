                        ...
                        <div class="signup-screen-single light">
                            ...
                            <form class="submit-form" method="POST">
                                ...
                                <div class="form-group password">
                                    ...
                                    <input type="password" class="form-control rounded" name="password" pattern="(?=.*\d)(?=.*[a-z]).{5,}" title="Must contain at least one number and letter, 
                                    and at least 5 or more characters" required>
