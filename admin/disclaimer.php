...
if(isset($_POST['cate_submit'])) 
  {
 $disclaimers =  $_POST['disclaimers'];
  
    
  $sal=mysqli_query($conn, "UPDATE `disclaimer` SET `terms`='".$disclaimers."' WHERE id = 4");
...
$select_category = $conn->query("SELECT * FROM `disclaimer` WHERE id = 4");
...
<head>
  ...
  <title> disclaimers  | <?php title();?></title>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#company_category_list" data-toggle="tab">disclaimers  List</a></li>
              <li ><a href="#create" id="edit_click" data-toggle="tab">Create disclaimers </a></li>
            </ul>
                  ...
                  <h2 class="card-inside-title"></h2>
                      <div class="row ">
                              ...
                              <div class="form-group col-sm-12">
                                  <label>Disclaimers   Point :</label>
                                 <textarea id="editor1"   name="disclaimers" required="">
...
<script type="text/javascript">
      ...
      $(document).ready(function(){
          ...
          {
                 $.ajax({
                      url:"ajax/select_disclaimer.php",
                      method:"POST",
                      dataType:"text",
