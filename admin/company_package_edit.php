<?php
 ...
 if (isset($_POST['mySubmitemp'])) {
    ...
    $insert = "UPDATE `package` SET  `package_price`='$package_price',`package_name`='$package_nm',`package_day`='$package_day',`package_description`='$description' WHERE id = '".$_GET['id']."'";
   	   ...
   	   $select_package=mysqli_query($conn,"SELECT * FROM `package` WHERE 
   	   id = '".$_GET['id']."' ");
      ...
      <section class="content">
         ...
         <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
               ...
               <li class="active"><a href="#create" id="edit_click" data-toggle="tab" >Company package Details</a></li>
            </ul>
