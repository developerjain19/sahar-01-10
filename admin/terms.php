...
if(isset($_POST['terms_add'])) 
 ...
 $terms = mysqli_real_escape_string($conn , $_POST['terms']);
  ...
  $sal=mysqli_query($conn, "UPDATE `termsandcondition` SET `terms`='".$terms."' WHERE id = 4");
...
$select_category = $conn->query("SELECT * FROM `termsandcondition` WHERE id = 4");
...
<head>
  ...
  <title> Terms and Condition | <?php title();?></title>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#company_category_list" data-toggle="tab">Terms and Condition List</a></li>
              <li ><a href="#create" id="edit_click" data-toggle="tab">Create Terms and Condition</a></li>
            </ul>
                  ...
                  <h2 class="card-inside-title"></h2>
                      <div class="row ">
                              ...
                              <div class="form-group col-sm-12">
                                  <label>Terms and Condition  Point :</label>
