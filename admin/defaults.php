...
$default = "SELECT * FROM `defaults` WHERE `id` = '1'";
$pr = mysqli_query($conn, $default);
$def = mysqli_fetch_array($pr);
...
if(isset($_POST['cate_submit'])) 
  {
    ...
    $folder2=date("dmyhis").$file;
    move_uploaded_file($tmpfile,'images/'.$folder2);  
      }
     else
     {
        $folder2 = $_POST['banner_new'];
     }
     
 $insert =  "UPDATE `defaults` SET `banner`='$folder2',`logo`='$folder' WHERE `id` = '1'";
  ...
  $sal=mysqli_query($conn, $insert);
      ...
      if($sal)
      {
echo '<script>window.location="defaults.php"</script>';
...
<head>
  ...
  <title> Default Images | <?php title();?></title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Default Images</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="#create" id="edit_click" data-toggle="tab">Create Default Images</a></li>
            </ul>
                      ...
                      <div class="row ">
                              ...
                              <div class="form-group col-sm-6">
                                ...
                                <input type="file" class="form-control" name="banner">
                                 <input type="hidden" class="form-control" name="banner_new" value="<?= $def['banner'] ?>">
                                 
                                 <img src="images/<?= $def['banner'] ?>" height="100px">
                              </div>
                           ...
                           <div class="form-group col-sm-6">
                                ...
                                <input type="hidden" class="form-control" name="logo_new" value="<?= $def['logo'] ?>">
                                 <img src="images/<?= $def['logo'] ?>" height="100px">
                              </div>
