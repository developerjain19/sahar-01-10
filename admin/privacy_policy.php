...
if(isset($_POST['policy_add'])) 
 ...
 $c =  $_POST['policy'];
	...
	$sal=mysqli_query($conn, "UPDATE `privacy_policy` SET `policy`='$c' WHERE id= 3 ");
...
else
{
 ...
 $qx=mysqli_query($conn,"select * from `privacy_policy` WHERE id = 3 ");
...
<head>
  ...
  <title> Privacy Policy | <?php title();?></title>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#company_category_list" data-toggle="tab">Privacy Policy List</a></li>
              <li ><a href="#create" id="edit_click" data-toggle="tab">Create Privacy Policy</a></li>
            </ul>
                  ...
                  <h2 class="card-inside-title"></h2>
                      <div class="row ">
                              ...
                              <div class="form-group col-sm-12">
                                  <label>Privacy Policy  Point :</label>
                                 <textarea id="editor1" name="policy" required="">
                                     <?= $up['policy'] ?>
                          ...
                          <div class="col-sm-12">
                              <button id="mySubmit" class="btn btn-primary" name="policy_add">Add</button>
                          </div>
                      </div>
              </form>
