...
if (isset($_POST['cate_submit'])) {
    ...
    $sal = mysqli_query($conn, "UPDATE `company_subcategory` SET `subcategory`='$subcategory' WHERE `subcat_id` = '" . $id . "' ");
...
$fetch = mysqli_query($conn, "SELECT * FROM `company_subcategory` WHERE `subcat_id` = '" . $id . "'");
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>
                    Company subcategory edit

                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                    <li class="active">Company subcategory edit</li>
                </ol>
            </section>
                                    ...
                                    <form id="company_subcategory_form" method="POST">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <input type="text" class="form-control" name="subcategory" value="<?= $data['subcategory'] ?>">
                                            </div>
