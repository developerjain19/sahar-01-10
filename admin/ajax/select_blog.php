...
while ($select_blog_row = $select_blog->fetch_assoc()) {
	...
	$output .= '     <tr>
                                <td> ' . $sno . ' </td>
                                <td><img src="../img/blog/' . $select_blog_row["blog_logo"] . '" width="100" height="70" alt="blog Logo" id="blog_logo'.$select_blog_row['blog_id'].'" onerror="defult_image(id);" /></td>
                                ...
                                <td><a target="_blank" href="'.website_url.''.$select_blog_row['blog_name'].'">' . $select_blog_row["blog_name"] . '</a></td>
                                 ...
                                 <td>
                                  <div class="form-group">
                                      <select class="form-control show-tick" name="blog_status" id="blog_status" onmousedown="this.value=" ";" onchange="edit_blog(' . $select_blog_row["blog_id"] . ' , this.value , id);" >
                                          ' . $option_status .'
                                      </select>
                                  </div>
                                </td>';
                                // <td>
                                //     <button class="btn btn-warning btn_edit" name="edit_btn" data-sid3="' . $select_blog_row["blog_id"] . '"><i class="fa fa-edit"></i> Edit </button>
                                // </td>
