...
<head>
  ...
  <title> Payment Report Company | <?php title();?></title>
...
?>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
         Payment Report Company

      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active"> Payment Report Company</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#blog_category_list" data-toggle="tab"> Payment Report Company List</a></li>
...
<script type="text/javascript">
      ...
      $(document).ready(function(){
          ...
          {
                 $.ajax({
                      url:"ajax/select_company_payment_report.php",
                      method:"POST",
                      dataType:"text",
