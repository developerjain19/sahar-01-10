...
if(isset($_POST['cate_submit'])) 
 ...
 $type =  $_POST['type'];
  ...
  $sal=mysqli_query($conn, "INSERT INTO `package_summary`(`type`,`points`) VALUES ('$type','$summary')");
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#company_category_list" data-toggle="tab">Package Summary List</a></li>
              <li ><a href="#create" id="edit_click" data-toggle="tab">Create Package Summary</a></li>
            </ul>
